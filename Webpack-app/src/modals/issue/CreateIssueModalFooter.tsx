...
interface CreateIssueModalFooterProps {
    onCancel: () => void;
    onSubmit: () => void;
...
function CreateIssueModalFooter({
    onCancel,
    onSubmit,
    isSubmitting = false,
    hasHeading,
    hasBody,
}: Readonly<CreateIssueModalFooterProps>) {
    const isValid = hasHeading && hasBody;
...
export default CreateIssueModalFooter;
